			...
			<div className="flex flex-col items-center gap-4">
				<div className="w-full flex justify-center">
					<img
						...
						width={320}
						height={200}
						className="rounded-xl object-cover shadow group-hover:shadow-lg transition-shadow duration-300 group-hover:scale-105 group-hover:-translate-y-2 transition-transform"
					/>
				</div>
				<Heading
					as="h3"
