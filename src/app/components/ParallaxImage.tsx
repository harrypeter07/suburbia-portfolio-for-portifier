...
export  function ParallaxImage({
    ...
    function animationFrame (){
        ...
        if(foregroundImageRef.current){
            foregroundImageRef.current.style.transform = `translate(${newX * 3}px, ${newY * 3}px)`;
        }
  ...
  return (
    <div className={clsx("grid grid-cols-1 place-items-center", className)}>
        	...
        	<div ref={backgroundImageRef} className="backgroundImage  col-start-1 row-start-1 transition-transform">
					<Image
						src={backgroundImage}
						height={500}
						width={500}
